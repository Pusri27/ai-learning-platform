...
export default async function EditLessonPage({ params }: { params: { courseId: string, lessonId: string } }) {
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Lesson</h2>
            </div>

            <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <form action="/api/admin/lessons/update" method="POST" className="space-y-6">
